...
\begin{figure}[htb]
    ...
    \caption[Physrisk physical risk model components.]{Conceptual architecture of a physical climate risk model, showing the integration of hazard data, vulnerability models, and asset-level exposure to produce impact distributions. Adapted from the CVAR Physrisk methodology \cite{cvar_phyrisk}.}
