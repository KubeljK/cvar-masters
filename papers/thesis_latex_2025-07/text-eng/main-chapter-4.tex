...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=\textwidth]{5d9e5739-4da0-461b-b1fb-dfb351b0ae04.png}
%     \caption{Physrisk hazard integration architecture, showing onboarding of raw models (left), Zarr-based storage (center), and downstream applications via API (right).}
%     \label{fig:physrisk_architecture}
% \end{figure}
...
The unified model was then uploaded to AWS S3 and integrated into the Physrisk hazard module alongside WRI and TU Delft models. This enabled direct comparison and batch evaluation of global versus local model predictions, described further in Section~4.4.

% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=0.9\textwidth]{00548351-a4bb-43ad-ae13-8315a1a15417.png}
%     \caption{Processing pipeline for unifying and integrating the SI IKG flood model.}
%     \label{fig:ikg_pipeline}
% \end{figure}

\subsection{Hazard Onboarding Pipeline}

The transformation from raw IKG data into a cloud-optimized flood hazard model is summarized in Figure~\ref{fig:onboarding_pipeline}. The pipeline consists of the following steps:
\begin{enumerate}
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=0.9\textwidth]{cd9b1828-382a-4dcb-9644-aef436dd1194.png}
%     \caption{Physrisk hazard onboarding pipeline for IKG model.}
%     \label{fig:onboarding_pipeline}
% \end{figure}
...
The final result of this pipeline is a unified flood hazard model for Slovenia covering all 18 areas of importance. This model:
\begin{itemize}
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=0.95\textwidth]{00548351-a4bb-43ad-ae13-8315a1a15417.png}
%     \caption{Pipeline for combining heterogeneous IKG flood models across 18 areas of importance.}
%     \label{fig:ikg_processing_pipeline}
% \end{figure}

This unified model was subsequently converted to Zarr format and onboarded into the Physrisk platform, as described in Section~4.3.
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=0.95\textwidth]{cd9b1828-382a-4dcb-9644-aef436dd1194.png}
%     \caption{Physrisk hazard onboarding pipeline for integrating the IKG model.}
%     \label{fig:ikg_onboarding}
% \end{figure}
